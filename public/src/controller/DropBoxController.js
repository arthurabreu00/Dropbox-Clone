class DropBoxController {
    ...
    connectFirebase() {
        var config = {
            apiKey: "AIzaSyCe57N5Wd-1t5J2JnWpxTJg4B4K2C3JH-c",
            authDomain: "dropbox-clone-d3453.firebaseapp.com",
            databaseURL: "https://dropbox-clone-d3453.firebaseio.com",
            projectId: "dropbox-clone-d3453",
            storageBucket: "dropbox-clone-d3453.appspot.com",
            messagingSenderId: "1001293099372"
        };
        ...
        return new Promise((resolve, reject) => {
            ...
            folderRef.on('value', snapshot => {
                ...
                if (snapshot.exists()) {
                    ...
                    this.getFireBaseRef('Arthur').child(key).remove();
    ...
    uploadProgress(event, file) {
        ...
        let porc = parseInt((loaded / total) * 100);
        let timeleft = ((100 - porc) * timeSpent) / porc;
        ...
        for (let index = 0; index < this.currentFolder.length; index++) {
            ...
            if ((index + 1) === this.currentFolder.length) {
                ...
                span.innerHTML = `
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" class="mc-icon-template-stateless" style="bottom: 2px; position: relative;">
